...
export DOT=$DOTPATH
export CLICOLOR=1
export CDPATH="~/code:~/code/work:~/Sites:~/Projects"                      # enable cd-ing into these directories from anywhere
...
search_and_destroy() {
  find . -type f -name "$1" -depth -delete;
}
...
pgr() { psql `heroku config:get DATABASE_URL`; }
